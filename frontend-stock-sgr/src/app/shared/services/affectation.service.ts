...
export class AffectationService {
  ...
  constructor(
    ...
    findAllAffectationsHistorique(){
      return this.http.get<Affectation[]>(this.apiUrl+'/affectations/all',{observe:'response'});
    }
...
findAllAffectationArticleByValidAt(){
  return this.http.get<AffectationArticle[]>(this.apiUrl+'/affectation-articles',{observe:'response'});
}
}
