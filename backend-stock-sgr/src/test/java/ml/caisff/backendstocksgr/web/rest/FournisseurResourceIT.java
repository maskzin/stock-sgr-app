...
class FournisseurResourceIT {
    ...
    private static final String DEFAULT_TELEHONE = "AAAAAAAAAA";
    private static final String UPDATED_TELEHONE = "BBBBBBBBBB";
    ...
    void createFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getNif()).isEqualTo(DEFAULT_NIF);
        assertThat(testFournisseur.getTelehone()).isEqualTo(DEFAULT_TELEHONE);
        assertThat(testFournisseur.getAdresse()).isEqualTo(DEFAULT_ADRESSE);
        assertThat(testFournisseur.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
        assertThat(testFournisseur.getUpdateAt()).isEqualTo(DEFAULT_UPDATE_AT);
    }
    ...
    void getAllFournisseurs() throws Exception {
        ...
        restFournisseurMockMvc
            ...
            .andExpect(jsonPath("$.[*].telehone").value(hasItem(DEFAULT_TELEHONE)))
    ...
    void getFournisseur() throws Exception {
        ...
        restFournisseurMockMvc
            ...
            .andExpect(jsonPath("$.telehone").value(DEFAULT_TELEHONE))
    ...
    void putNewFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getNif()).isEqualTo(UPDATED_NIF);
        assertThat(testFournisseur.getTelehone()).isEqualTo(UPDATED_TELEHONE);
        assertThat(testFournisseur.getAdresse()).isEqualTo(UPDATED_ADRESSE);
        assertThat(testFournisseur.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
        assertThat(testFournisseur.getUpdateAt()).isEqualTo(UPDATED_UPDATE_AT);
    }
    ...
    void partialUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.nif(UPDATED_NIF).telehone(UPDATED_TELEHONE).adresse(UPDATED_ADRESSE);
