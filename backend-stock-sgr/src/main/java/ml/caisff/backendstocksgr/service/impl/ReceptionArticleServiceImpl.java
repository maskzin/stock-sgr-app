...
public class ReceptionArticleServiceImpl implements ReceptionArticleService {
    ...
    @Override
    @Transactional
    public List<ReceptionArticle> findReceptionArticleById(Long id)
    {
        log.debug("Request to get ReceptionArticles by Id");
        return receptionArticleRepository.findReceptionArticleByArticleId(id);
    }
    ...
    public List<ReceptionArticle> findAll() {
        ...
        return receptionArticleRepository.findAll(Sort.by(Sort.Direction.DESC,"id"));
    }
