...
/**
 * REST controller for managing {@link ml.caisff.backendstocksgr.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    public List<Article> findArticleByCategorieId(@PathVariable  Long id){
        log.debug("REST request to get Article by categorie: {}", id);
        return articleService.findArticleByCategorieId(id);
    }

    @GetMapping("/articles/marque/{id}")
    public List<Article> findArticleByMarqueId(@PathVariable  Long id){
        log.debug("REST request to get Article by categorie: {}", id);
        return articleService.findArticleByMarqueId(id);
    }
