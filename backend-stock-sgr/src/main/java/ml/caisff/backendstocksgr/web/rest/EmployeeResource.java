...
/**
 * REST controller for managing {@link ml.caisff.backendstocksgr.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    /**
     * {@code GET /employees/division/:id} : get all the employees.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of employees in body.
     */
    @GetMapping("/employees/division/{id}")
    public List<Employee> getEmployeesByDivisionId(@PathVariable Long id){
        log.debug("REST request to get all Employees By Division ID");
        return employeeService.findEmployeesByDivisionId(id);
    }
